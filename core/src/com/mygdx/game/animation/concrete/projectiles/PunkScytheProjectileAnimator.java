...
public class PunkScytheProjectileAnimator extends ProjectileAnimator {
    ...
    protected AnimationsMap createAnimationsMap() {
        ...
        animations.put(State.FLYING, new AnimationBuilder(AssetsNames.PUNK_SCYTHEPROJECTILE_FLYING_SPRITESHEET)
                .rows(1)
                .cols(1)
                .frameDuration(1)
                .playMode(Animation.PlayMode.NORMAL)
                .build());
        animations.put(State.EXPLODING, new AnimationBuilder(AssetsNames.PUNK_SCYTHEPROJECTILE_EXPLODING_SPRITESHEET)
                .rows(1)
                .cols(2)
                .playMode(Animation.PlayMode.NORMAL)
                .veryHighPriority()
