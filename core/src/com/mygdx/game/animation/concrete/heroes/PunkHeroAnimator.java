...
/**
 * Animator class specifically for a punk hero character.
 */
public class PunkHeroAnimator extends HeroAnimator {

    /**
     * Creates and initializes a map of animations for the punk hero character.
     *
     * @return AnimationsMap containing all animations for different states of the punk hero.
     */
    @Override
